...
import Main.java.Filter.Filters.ExistFilter;
import Main.java.Filter.Filters.GreaterThanFilter;
import Main.java.Filter.Filters.NotEqualsFilter;
import Main.java.Filter.Filters.OrFilter;
    ...
    private Filter chooseFilter(String strFilter) {
        ...
        switch (comparator){
            case "=":
                ...
                break;
            case "<":
                outputFilter = new Main.java.Filter.Filters.LessThanFilter(property,value);
                break;
            case ">":
